...
{
    /// <summary>
    /// This class holds weather data. Always check wasSuccessfull before probing for data.
    /// </summary>
    class WeatherReport
    {
        ...
        private const String API_REQUEST_TAIL = ".json";
        private const String CONDITIONS = "/conditions/q/";
        private const String FORECAST = "/forecast/q/";
        private const String AUTO_IP = "autoip";
        ...
        // The ZIP code to get the weather of.
        ...
        #region Constructor
        /// <summary>
        /// This class gathers and holds weather data. All information comes from the WeatherUnderground API.
        ...
        /// <param name="zip_code">The ZIP code to get the weather at</param>
        /// <exception cref="System.IO.IOException"></exception>
        public WeatherReport(String api_key, String zip_code)
        {
        ...
        /// <param name="api_key">A key to the WU API</param>
        /// <exception cref="System.IO.IOException"></exception>
        public WeatherReport(String api_key) : this(api_key, AUTO_IP)
        {
        }
        ...
        /// <para/>This method is safe whether or not the report was successful.
        /// </summary>
        ...
        private dynamic connectToAPI(String report_type)
        {
            ...
            {
                var URL = API_REQUEST_HEAD + api_key + report_type + zip_code + API_REQUEST_TAIL;
